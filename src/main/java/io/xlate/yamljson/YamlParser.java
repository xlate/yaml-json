...
final class YamlParser implements JsonParser, JsonLocation {
    ...
    YamlParser(Parse yamlParser, Reader yamlReader) {
        this.yamlEvents = yamlParser.parseReader(yamlReader).iterator();
    ...
    boolean enqueueEvent(org.snakeyaml.engine.v2.events.Event yamlEvent) {
        ...
        case StreamEnd:
            ...
            break;
        default:
            throw new IllegalStateException("Unknown state: " + yamlEvent.getEventId());
        }
